...
The type system includes `Int`, `Float`, `Bool`, `String`, `Bytes`, arrays, maps, sets, structs, enums, `Option`, `Result`, channels, threads, JSON, and WebSockets. Arithmetic is checked, conversions are explicit, and filesystem, network, process, and concurrency operations stay behind typed builtins with bounded resources.
