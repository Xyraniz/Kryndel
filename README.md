...
graphs with deterministic missing, duplicate, and cycle diagnostics. `stdlib/core/compiler.kry` lowers the same subset into bytecode records accepted by the source verifier.
...
current checkout runs 98 Python unit tests; the
