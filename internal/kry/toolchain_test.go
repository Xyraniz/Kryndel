...
func TestDocumentation(t *testing.T) {
	paths := []string{"README.md", "CONTRIBUTING.md", "CHANGELOG.md", "docs/native.md", "docs/stdlib.md", "docs/packages.md", "docs/discord.md", "docs/windows.md", "docs/architecture.md", "docs/design.md", "docs/release.md", "docs/testing.md", "docs/concurrency.md", "docs/memory.md", "docs/modules.md", "docs/system.md", "docs/lsp.md"}
