...
| Artifacts | Deterministic builds, KRYNATIVE4 metadata, KRYNATIVE3 compatibility, exact lengths, SHA-256 hashes, embedded dependencies, path safety, trailing bytes, truncated payloads, version mismatch, invalid payloads, and replay after dependency removal. |
