...
| Source JSON parser seam | `stdlib/core/json.kry`, `json-source-v1.json`, `bytecode-schema-source-v1.json`, JSON/schema regressions | Kryndel source parses JSON values and constructs a verifier-compatible bytecode subset under the Python VM; full schema parity, file input, and production KEXE decoding remain Python |
