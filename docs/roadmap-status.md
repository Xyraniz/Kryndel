...
| 5. Kryndel-native SHA-256 or verifier | Structural verifier, KEXE framing, and SHA-256 source seams connected for checksum comparison; JSON/module decoding pending | `stdlib/core/bytecode.kry` validates normalized v1 records, `stdlib/core/artifact.kry` validates KEXE magic/length and canonicalizes checksum text, and `stdlib/core/sha256.kry` verifies the extracted payload; Python still parses JSON/KEXE and owns production artifact/package checksums |
