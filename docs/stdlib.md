...
| `core/json` | `parse(String) -> JsonResult` | Source-level JSON value parser for null, booleans, numbers, strings, arrays, and objects; bytecode schema validation, ModuleRecord construction, and production KEXE decoding remain Python |
