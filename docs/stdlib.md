...
| `core/artifact` | `read_header(Bytes) -> ReadResult` | Source-level KEXE v1 framing reader validates magic/length and exposes checksum/payload bytes; SHA-256, JSON/module decoding, and production artifact verification remain Python |
