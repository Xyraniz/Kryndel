...
- Added `stdlib/core/sha256.kry` with arithmetic-only SHA-256 over nominal `Bytes`, known vectors for empty/single-block/multi-block inputs, and `KRY6205` digest verification. It is a source seam under the Python VM and is not yet wired into KEXE/package production paths.
...
- Regression tests expanded to 110, including nested modules, public/private
